...
class PostOffice {
    public:
        ...
        void SendTCP(PacketHeader pktHdr, MailHeader mailHdr, const char *data);
        void ReceiveTCP(int box, PacketHeader *pktHdr,	MailHeader *mailHdr, char *data);
